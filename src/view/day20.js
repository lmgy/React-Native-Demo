...
import { Image,StyleSheet,Text,TextInput,LayoutAnimation,TouchableHighlight,View } from 'react-native';
  ...
  render() {
    return(
      <View style={styles.container}>
        <ReminderContainer navigation={this.props.navigation} listData={this.listData}/>
      </View>
    );
  }
}
